 ...
 */
public class Neurologicas extends javax.swing.JFrame {

    /**
     * Creates new form Neurologicas
     */
    public Neurologicas() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("-Enfermedades neurológicas-");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Neurologicas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Neurologicas().setVisible(true);
            }
        });
    }
