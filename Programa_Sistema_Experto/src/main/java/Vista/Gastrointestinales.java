 ...
 */
public class Gastrointestinales extends javax.swing.JFrame {

    /**
     * Creates new form Gastrointestinales
     */
    public Gastrointestinales() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("-Enfermedades gastrointestinales-");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Gastrointestinales.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Gastrointestinales().setVisible(true);
            }
        });
    }
