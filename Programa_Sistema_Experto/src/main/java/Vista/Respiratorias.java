 ...
 */
public class Respiratorias extends javax.swing.JFrame {

    /**
     * Creates new form Respiratorias
     */
    public Respiratorias() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("-Enfermedades respiratorias-");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Respiratorias.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Respiratorias().setVisible(true);
            }
        });
    }
